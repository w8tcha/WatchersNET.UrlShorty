...
namespace WatchersNET.DNN.Modules.UrlShorty
{
    ...
    public partial class UrlShorty : ModuleSettingsBase, IActionable
    {
        ...
        private void RegisterJs()
        {
            ...
            ScriptManager.RegisterClientScriptInclude(
                 this, csType, "zeroclipboard", this.ResolveUrl("js/zeroclipboard.js"));
            ...
            sbDialogJs.AppendFormat("title: '{0}',", Localization.GetString("ErrorTitle.Text", this.LocalResourceFile));
