...
namespace WatchersNET.DNN.Modules.UrlShorty
{
    ...
    public partial class Dnn404 : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!settingsDictionary.ContainsKey(string.Format("{0}UseErrorLog", sPortalKey)))
            {
                return;
            }

            if (string.IsNullOrEmpty(settingsDictionary[string.Format("{0}UseErrorLog", sPortalKey)]))
            {
                return;
            }
            ...
            if (!bool.TryParse(settingsDictionary[string.Format("{0}UseErrorLog", sPortalKey)], out result))
            {
                return;
            }
