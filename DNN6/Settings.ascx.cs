...
namespace WatchersNET.DNN.Modules.UrlShorty
{
    ...
    public partial class Settings : ModuleSettingsBase
    {
        ...
        private void LoadModuleSettings()
        {
            ...
            Dictionary<string, string> settingsDictionary = HostController.Instance.GetSettingsDictionary();
            ...
            if (settingsDictionary.ContainsKey(string.Format("{0}UseErrorLog", sPortalKey)))
            {
                ...
                {
                    bool bResult;
                    if (bool.TryParse(settingsDictionary[string.Format("{0}UseErrorLog", sPortalKey)], out bResult))
                    {
        ...
        private void SaveChanges()
        {
            ...
            HostController.Instance.Update(
                ...
                {
                    Key = string.Format("{0}UseErrorLog", sPortalKey),
                    Value = this.cBUseErrorLog.Checked.ToString(),
                    IsSecure = false
                });
        }
