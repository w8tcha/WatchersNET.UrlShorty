    ...
    public partial class UrlShorty : ModuleSettingsBase, IActionable
    {
                    ...
                    {
                        {
                            ...
                            this.EditUrl("History"), false, SecurityAccessLevel.Edit, true, false
                            }, 
                        {
                            this.GetNextActionID(), "404 Error Log", ModuleActionType.AddContent, string.Empty, 
                            string.Empty, this.EditUrl("ErrorLog"), false, SecurityAccessLevel.Edit, true, false
                            }
                    };
        ...
        private void InitializeComponent()
        {
            ...
            PageBase.RegisterStyleSheet(
                this.Page, "//ajax.googleapis.com/ajax/libs/jqueryui/1/themes/south-street/jquery-ui.css");

            PageBase.RegisterStyleSheet(this.Page, this.ResolveUrl("css/ui.jqgrid.css"));
